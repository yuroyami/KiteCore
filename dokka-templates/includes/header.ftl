<#--
  ...
  https://yuroyami.github.io/KiteCore/ and https://github.com/yuroyami/KiteCore are substituted per repository by
...
<#macro display>
    <header class="navigation theme-dark" id="navigation-wrapper" role="banner">
        ...
        <nav class="kite-nav-links" aria-label="Kite documentation">
            <a href="https://yuroyami.github.io/KiteCore/">Guide</a>
            <a href="https://github.com/yuroyami/KiteCore">GitHub</a>
        </nav>
